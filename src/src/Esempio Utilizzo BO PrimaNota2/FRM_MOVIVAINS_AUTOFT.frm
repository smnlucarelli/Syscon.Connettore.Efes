...
Begin VB.Form FRM_MOVIVAINS_AUTOFT 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Inserimento prima nota - movimento IVA con autofattura"
   ClientHeight    =   7020
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9285
   Icon            =   "FRM_MOVIVAINS_AUTOFT.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.CommandButton CMD_VIEW 
      ...
      Height          =   525
      Left            =   7950
      Picture         =   "FRM_MOVIVAINS_AUTOFT.frx":27A2
      Style           =   1  'Graphical
      TabIndex        =   30
      Top             =   6480
      Width           =   1305
   ...
   Begin VB.CommandButton CMD_INSERT 
      ...
      Height          =   525
      Left            =   7950
      Picture         =   "FRM_MOVIVAINS_AUTOFT.frx":28EC
      Style           =   1  'Graphical
      TabIndex        =   29
      Top             =   4620
      Width           =   1305
   ...
   End
End
Attribute VB_Name = "FRM_MOVIVAINS_AUTOFT"
...
Private Sub CMD_INSERT_Click()
    ...
    With Pcls_PrimaNota.PGestRegPN.CPInput.DatiTestata
        ...
        .NumeroDocumento = 0 ' TXT_NUMDOC.Text
        ...
        '
        .CodiceSezionaleAutofattura = TXT_SEZAUTO.Text
        .NumeroDocumentoAutofattura = TXT_NUMDOCAUTO.Text
    End With
    ...
    '
    Pcls_PrimaNota.CPInput.RegistraIntra = True
...
''    If Pcls_PrimaNota.PGestRegPN.Stato <> tsOK Then
''        MsgBox Pcls_PrimaNota.PGestRegPN.Errore & " in Pcls_PrimaNota.PGestRegPN.ModificaRegistrazione"
''        Exit Sub
''    End If
''
''    Pcls_PrimaNota.PGestRegPN.CPInput.DatiTestata.NumeroDocumento = TXT_NUMDOC.Text
''    '
''    ' Dati per autofattura
''    '
''    Pcls_PrimaNota.PGestRegPN.CPInput.DatiTestata.CodiceSezionaleAutofattura = TXT_SEZAUTO.Text
''    Pcls_PrimaNota.PGestRegPN.CPInput.DatiTestata.NumeroDocumentoAutofattura = TXT_NUMDOCAUTO.Text
''
''    Pcls_PrimaNota.Status = tsModify
''    Pcls_PrimaNota.PGestRegPN.ModificaTestata tsModificaTestataProtocollo + tsModificaTestataSezionaleAutofattura + tsModificaTestataProtocolloAutofattura
''
''    Pcls_PrimaNota.ModificaPrimaNota StatoFinale
''    If Pcls_PrimaNota.Stato <> tsOK Then
''        MsgBox Pcls_PrimaNota.Errore & " in Pcls_PrimaNota.ModificaPrimaNota"
''        Exit Sub
''    End If
