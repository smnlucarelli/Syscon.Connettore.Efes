...
Begin VB.Form FRM_MOVIVAINS_IVAAUTO_REPEAT 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Inserimento prima nota - movimento IVA - riga IVA automatica"
   ClientHeight    =   9060
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9285
   Icon            =   "FRM_MOVIVAINS_IVAAUTO_REPEAT.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame3 
      Caption         =   "Modalità gestione IVA non det. / pro rata"
      Height          =   1125
      Left            =   60
      TabIndex        =   65
      Top             =   4470
      Width           =   9195
      Begin PRJFW_COMBOBOX.TMS_COMBO CBO_PRORATA 
         Height          =   315
         Left            =   1500
         TabIndex        =   69
         Top             =   690
         ...
         Default         =   "0"
         IsDbField       =   0   'False
         Caption         =   "Tipo pro-rata"
         Object.Tag             =   "Tipo pro-rata"
         CanRequired     =   0   'False
      End
      Begin VB.Label Label32 
         Caption         =   "IVA pro rata"
         Height          =   195
         Left            =   150
         TabIndex        =   68
         Top             =   750
      ...
      Begin VB.Label Label31 
         ...
         Width           =   1275
      End
      Begin PRJFW_COMBOBOX.TMS_COMBO CBO_INDDETRIVA 
         Height          =   315
         Left            =   1320
         TabIndex        =   66
         Top             =   300
         ...
         MaxChar         =   40
         IsDbField       =   0   'False
         Caption         =   "Indicatore trattamento indetraibilità IVA"
         Object.Tag             =   "Indicatore trattamento indetraibilità IVA"
      End
   End
   Begin MSDataGridLib.DataGrid GRID_CPART 
      Height          =   1125
      Left            =   60
      TabIndex        =   64
      Top             =   5610
   ...
   Begin VB.CommandButton CMD_VIEW 
      ...
      Height          =   525
      Left            =   7950
      Picture         =   "FRM_MOVIVAINS_IVAAUTO_REPEAT.frx":27A2
      Style           =   1  'Graphical
      TabIndex        =   28
      Top             =   8520
      Width           =   1305
   ...
   Begin VB.CommandButton CMD_INSERT 
      ...
      Height          =   525
      Left            =   7950
      Picture         =   "FRM_MOVIVAINS_IVAAUTO_REPEAT.frx":28EC
      Style           =   1  'Graphical
      TabIndex        =   27
      Top             =   6780
      Width           =   1305
   ...
   End
End
Attribute VB_Name = "FRM_MOVIVAINS_IVAAUTO_REPEAT"
...
Private Sub CMD_INSERT_Click()
    ...
    For Indice = 1 To NumMov
        ...
        Pcls_PrimaNota.PGestRegPN.CPInput.DatiDettaglio.IndicatoreGestioneProRata = CBO_PRORATA.Text
        Pcls_PrimaNota.PGestRegPN.CPInput.DatiDettaglio.IndicatoreIndetraibilitaIVA = CBO_INDDETRIVA.Text
        ...
        Set GRID_CPART.DataSource = Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont
...
Private Sub CaricaComboIndDetrIvaProRata()
    On Error Resume Next
    
    With CBO_INDDETRIVA
        .EraseCombo
        .AddItemData "Inglobata nel conto di costo", 1
        .AddItemData "Distinta dal costo (su conto apposito)", 2
        .Text = 1
    End With
    ...
    With CBO_PRORATA
        .EraseCombo
        .AddItemData "No", 0
        .AddItemData "Si inglobata nel conto di costo", 1
        .AddItemData "Si su conto apposito", 2
        .Text = 0
    End With
