...
Begin VB.Form FRM_MOVIVADEL 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Cancellazione prima nota - movimento IVA"
   ClientHeight    =   5175
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7440
   Icon            =   "FRM_MOVIVADEL.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.CommandButton CMD_MODIFICA 
      ...
      Height          =   525
      Left            =   3750
      Picture         =   "FRM_MOVIVADEL.frx":27A2
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   150
      Width           =   1305
   ...
   Begin VB.CommandButton CMD_DELETE 
      ...
      Height          =   525
      Left            =   6060
      Picture         =   "FRM_MOVIVADEL.frx":28EC
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   2820
      Width           =   1305
   ...
   End
End
Attribute VB_Name = "FRM_MOVIVADEL"
