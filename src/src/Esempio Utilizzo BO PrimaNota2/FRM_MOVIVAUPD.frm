...
Begin VB.Form FRM_MOVIVAUPD 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Modifica prima nota - movimento IVA"
   ClientHeight    =   8010
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7980
   Icon            =   "FRM_MOVIVAUPD.frx":0000
   LinkTopic       =   "Form2"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.CommandButton CMD_CANCELLARIGHE 
      Caption         =   "Cancella righe"
      Height          =   375
      Left            =   6630
      Style           =   1  'Graphical
      TabIndex        =   53
   ...
   Begin VB.CommandButton CMD_UPDATE 
      ...
      Height          =   525
      Left            =   6630
      Picture         =   "FRM_MOVIVAUPD.frx":27A2
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   6240
      Width           =   1305
   ...
   Begin VB.CommandButton CMD_VIEW 
      ...
      Height          =   525
      Left            =   6060
      Picture         =   "FRM_MOVIVAUPD.frx":28EC
      Style           =   1  'Graphical
      TabIndex        =   9
      Top             =   7470
      Width           =   1305
   ...
   Begin VB.CommandButton CMD_MODIFICA 
      ...
      Height          =   525
      Left            =   6120
      Picture         =   "FRM_MOVIVAUPD.frx":2A36
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   180
      Width           =   1305
   ...
   End
End
Attribute VB_Name = "FRM_MOVIVAUPD"
...
Private Sub CMD_UPDATE_Click()
    ...
    '
    ' Modifica ID divisione
    '
    CampiDaModificareTestata = CampiDaModificareTestata + tsModificaTestataIdDivisione
    Pcls_PrimaNota.PGestRegPN.CPInput.DatiTestata.Divisione_ID = 5
...
Private Sub CMD_CANCELLARIGHE_Click()
'''    Dim RecSetCG42      As ADODB.Recordset
'''    Dim NumRigaCont     As Variant
'''
'''    On Error GoTo Err_CMD_CANCELLARIGHE_Click
'''
'''    '
'''    ' Distruggo il b.o. prima nota
'''    '
'''    DistruggiOggettoPrimaNota
'''
'''    Set Pcls_PrimaNota = New CGBO_PRIMANOTA.CLSCG_PRIMANOTA
'''
'''    '
...
'''    End With
'''
'''    Pcls_PrimaNota.PGestRegPN.CPInput.GestioneAutomaticaContropartiteIVA = True
'''
'''    Pcls_PrimaNota.PGestRegPN.CPInput.Sconnect = StrConnect
'''    Set Pcls_PrimaNota.PGestRegPN.CPInput.GConnect = Connessione
'''    Pcls_PrimaNota.PGestRegPN.ModificaRegistrazione
...
'''
'''    '
'''    ' Loop sulle righe contabili per la cancellazione
'''    '
'''    Set RecSetCG42 = Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetCG42.Clone
'''
'''    If Not RecSetCG42 Is Nothing Then
'''        If RecSetCG42.RecordCount > 0 Then
'''            RecSetCG42.MoveFirst
'''
'''            While Not RecSetCG42.EOF
'''                NumRigaCont = RecSetCG42.Fields("CG42_NUMRIGACONT").Value
'''
'''                Pcls_PrimaNota.PGestRegPN.CPInput.DatiDettaglio.CodiceDitta = CallingForm.ActiveInterface.ClsGlobal.Gcls_DittaCorrente.CodDitta
'''                Pcls_PrimaNota.PGestRegPN.CPInput.DatiDettaglio.NumeroRegistrazione = TXT_NUMREG.Text
'''                Pcls_PrimaNota.PGestRegPN.CPInput.DatiDettaglio.NumeroRigaCont = NumRigaCont
'''
'''                Pcls_PrimaNota.PGestRegPN.CancellaRiga
'''                If Pcls_PrimaNota.PGestRegPN.Stato <> tsOk Then
'''                    MsgBox Pcls_PrimaNota.PGestRegPN.Errore & " in Pcls_GestRegPN.CancellaRiga"
'''                    Exit Sub
'''                End If
'''
'''                RecSetCG42.MoveNext
...
'''
'''
'''    Set RecSetCG42 = Nothing
'''
'''Exit Sub
'''Err_CMD_CANCELLARIGHE_Click:
'''    MsgBox Err.Number & " - " & Err.Description, , "CMD_CANCELLARIGHE_Click"
'''    Exit Sub
End Sub

Private Sub DistruggiOggettoPrimaNota()
    Dim RSOggetto       As Object
    ...
    Set Pcls_PrimaNota.PGestRegPN = Nothing
    Set Pcls_PrimaNota.CPInput = Nothing
    Set Pcls_PrimaNota.CPOutput = Nothing
    Set Pcls_PrimaNota.ActiveInterface = Nothing
