...
Object = "{F53BE214-7AC6-11D0-9B0E-006097A80EFD}#6.8#0"; "TMS_LABEL.ocx"
Begin VB.Form FRM_MOVIVAINS 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Inserimento prima nota - movimento IVA"
   ClientHeight    =   7365
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9285
   Icon            =   "FRM_MOVIVAINS.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame3 
      Caption         =   "Dati relativi alle scadenze:"
      Height          =   705
      Left            =   60
      TabIndex        =   64
      Top             =   4080
      Width           =   9195
      Begin PRJFW_EDIT.TxtEdit TXT_CUP 
         Height          =   300
         Left            =   3900
         TabIndex        =   65
         ToolTipText     =   "Codice unico progetto"
         Top             =   240
         Width           =   1875
         _ExtentX        =   3307
         _ExtentY        =   529
         ...
         Carattere       =   0   'False
         IsDbField       =   0   'False
         Caption         =   "Codice unico progetto"
         Object.Tag             =   "Codice unico progetto"
         MaxWidth        =   15
         CanRequired     =   0   'False
      End
      Begin PRJFW_EDIT.TxtEdit TXT_CIG 
         Height          =   300
         Left            =   1140
         TabIndex        =   67
         ToolTipText     =   "Codice identificativo di gara"
         Top             =   240
         Width           =   1275
         _ExtentX        =   2249
         _ExtentY        =   529
         ...
         Carattere       =   0   'False
         IsDbField       =   0   'False
         Caption         =   "Codice identificativo di gara"
         Object.Tag             =   "Codice identificativo di gara"
         CanRequired     =   0   'False
      End
   ...
   Begin VB.CommandButton CMD_VIEW 
      ...
      Height          =   525
      Left            =   7950
      Picture         =   "FRM_MOVIVAINS.frx":27A2
      Style           =   1  'Graphical
      TabIndex        =   28
      Top             =   6780
      Width           =   1305
   ...
   Begin VB.CommandButton CMD_INSERT 
      ...
      Height          =   525
      Left            =   7950
      Picture         =   "FRM_MOVIVAINS.frx":28EC
      Style           =   1  'Graphical
      TabIndex        =   27
      Top             =   4920
      Width           =   1305
   ...
   End
End
Attribute VB_Name = "FRM_MOVIVAINS"
...
''    Pcls_PrimaNota.PGestRegPN.CPInput.DatiTestata.NumeroDocumentoAutofattura = 888
    ...
    '
    ' Definizione recordset scadenze
    '
...
Private Function GeneraRecordsetScadenze() As ADODB.Recordset
    ...
    PClsScadenze.CUP = TXT_CUP.Text
    PClsScadenze.CIG = TXT_CIG.Text
    
    PClsScadenze.ImportFattureDaFileASCII = True
