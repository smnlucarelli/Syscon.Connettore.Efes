...
Begin VB.Form FRM_MOVIVAINS_IVAAUTO 
   ...
   ClientTop       =   330
   ClientWidth     =   9285
   Icon            =   "FRM_MOVIVAINS_IVAAUTO.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.CommandButton CMD_VIEW 
      ...
      Height          =   525
      Left            =   7950
      Picture         =   "FRM_MOVIVAINS_IVAAUTO.frx":27A2
      Style           =   1  'Graphical
      TabIndex        =   28
      Top             =   8520
      Width           =   1305
   ...
   Begin VB.CommandButton CMD_INSERT 
      ...
      Height          =   525
      Left            =   7950
      Picture         =   "FRM_MOVIVAINS_IVAAUTO.frx":28EC
      Style           =   1  'Graphical
      TabIndex        =   27
      Top             =   6780
      Width           =   1305
   ...
   End
End
Attribute VB_Name = "FRM_MOVIVAINS_IVAAUTO"
