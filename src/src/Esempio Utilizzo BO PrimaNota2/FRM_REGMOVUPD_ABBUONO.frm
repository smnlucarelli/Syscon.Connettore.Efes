...
Begin VB.Form FRM_REGMOVUPD_ABBUONO 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Modifica prima nota - diversi a diversi con abbuono"
   ClientHeight    =   7020
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10260
   Icon            =   "FRM_REGMOVUPD_ABBUONO.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.CommandButton CMD_MODIFICA 
      ...
      Height          =   465
      Left            =   6120
      Picture         =   "FRM_REGMOVUPD_ABBUONO.frx":27A2
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   30
      Width           =   1305
   ...
   Begin VB.CommandButton CMD_VIEW 
      ...
      Height          =   465
      Left            =   7770
      Picture         =   "FRM_REGMOVUPD_ABBUONO.frx":28EC
      Style           =   1  'Graphical
      TabIndex        =   22
      Top             =   6540
      Width           =   1305
   ...
   Begin VB.CommandButton CMD_UPDATE 
      ...
      Height          =   465
      Left            =   8910
      Picture         =   "FRM_REGMOVUPD_ABBUONO.frx":2A36
      Style           =   1  'Graphical
      TabIndex        =   21
      Top             =   5970
      Width           =   1305
   ...
   Begin VB.Frame Frame2 
      ...
      Begin PRJFW_EDITDEFCONTO.TxtEditDefConto TXT_CONTO2NEW 
         ...
         CanRequired     =   0   'False
      End
      Begin PRJFW_EDITDEFCONTO.TxtEditDefConto TXT_CONTO3OLD 
         Height          =   300
         Left            =   945
         TabIndex        =   70
         Top             =   3180
         ...
         CanRequired     =   0   'False
      End
      Begin PRJFW_EDITDEFCONTO.TxtEditDefConto TXT_CONTO3NEW 
         Height          =   300
         Left            =   5295
         TabIndex        =   16
         Top             =   3180
         ...
         CanRequired     =   0   'False
      End
      Begin PRJFW_EDIT.TxtEdit TXT_DESCRAGG3OLD 
         Height          =   300
         Left            =   945
         TabIndex        =   77
         Top             =   3510
         ...
         CanRequired     =   0   'False
      End
      Begin PRJFW_EDITNUM.TxtEditNum TXT_ABBUONO3OLD 
         Height          =   300
         Left            =   4395
         TabIndex        =   83
         Top             =   3840
      ...
      Begin VB.Label Label32 
         ...
         Width           =   855
      End
      Begin PRJFW_COMBOBOX.TMS_COMBO CBO_SEGNO3OLD 
         Height          =   315
         Left            =   3045
         TabIndex        =   71
         Top             =   3840
         ...
         CanRequired     =   0   'False
      End
      Begin PRJFW_EDITNUM.TxtEditNum TXT_ABBUONO3NEW 
         Height          =   300
         Left            =   8145
         TabIndex        =   20
         Top             =   3840
      ...
      Begin VB.Label Label29 
         ...
         Width           =   915
      End
      Begin PRJFW_EDIT.TxtEdit TXT_DESCRCONTO3OLD 
         Height          =   300
         Left            =   2385
         TabIndex        =   79
         Top             =   3180
         ...
         CanRequired     =   0   'False
      End
      Begin PRJFW_EDITNUM.TxtEditNum TXT_IMPORTO3OLD 
         Height          =   300
         Left            =   945
         TabIndex        =   78
         Top             =   3840
      ...
      Begin VB.Label Label28 
         ...
         Width           =   735
      End
      Begin PRJFW_EDIT.TxtEdit TXT_DESCRCONTO3NEW 
         Height          =   300
         Left            =   7215
         TabIndex        =   75
         Top             =   3180
         ...
         CanRequired     =   0   'False
      End
      Begin PRJFW_EDITNUM.TxtEditNum TXT_IMPORTO3NEW 
         Height          =   300
         Left            =   5295
         TabIndex        =   18
         Top             =   3840
         ...
         CanRequired     =   0   'False
      End
      Begin PRJFW_EDIT.TxtEdit TXT_DESCRAGG3NEW 
         Height          =   300
         Left            =   5295
         TabIndex        =   17
         Top             =   3510
      ...
      Begin VB.Line Line2 
         ...
         Y2              =   2850
      End
      Begin PRJFW_COMBOBOX.TMS_COMBO CBO_SEGNO3NEW 
         Height          =   315
         Left            =   6915
         TabIndex        =   19
         Top             =   3840
         ...
         CanRequired     =   0   'False
      End
      Begin PRJFW_EDITNUM.TxtEditNum TXT_ABBUONO2NEW 
         Height          =   300
         Left            =   8160
         TabIndex        =   15
         Top             =   2490
         ...
         CanRequired     =   0   'False
      End
      Begin PRJFW_EDITNUM.TxtEditNum TXT_ABBUONO1NEW 
         Height          =   300
         Left            =   8160
         TabIndex        =   10
         Top             =   1140
         ...
         CanRequired     =   0   'False
      End
      Begin PRJFW_EDITNUM.TxtEditNum TXT_ABBUONO2OLD 
         Height          =   300
         Left            =   4410
         TabIndex        =   68
         Top             =   2490
      ...
      Begin VB.Label Label24 
         ...
         Width           =   855
      End
      Begin PRJFW_EDITNUM.TxtEditNum TXT_ABBUONO1OLD 
         Height          =   300
         Left            =   4410
         TabIndex        =   66
         Top             =   1140
   ...
   End
End
Attribute VB_Name = "FRM_REGMOVUPD_ABBUONO"
...
Private Sub CMD_MODIFICA_Click()
    ...
    If Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.RecordCount > 0 Then
        ...
        If NVL(Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_TIPOCF_CG44").Value, -1) = -1 Then
            TXT_CONTO1OLD.Text = Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_CONTOPAR_CG24").Value
        Else
            TXT_CONTO1OLD.Text = MakeContoCliFor(Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_TIPOCF_CG44").Value, _
                                                 Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_CLIFORPAR_CG44").Value)
        End If
        ...
        TXT_CONTO1NEW.Text = TXT_CONTO1OLD.Text '  Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_CONTOPAR_CG24").Value
        ...
        If Not Pcls_PrimaNota.PGestRegPN.CPOutput.ClsAbbuoni Is Nothing Then
            If Not Pcls_PrimaNota.PGestRegPN.CPOutput.ClsAbbuoni.RecSetDatiPerAbbuoni Is Nothing Then
                Pcls_PrimaNota.PGestRegPN.CPOutput.ClsAbbuoni.RecSetDatiPerAbbuoni.Filter = _
                           "RIGACONT = " & Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_NUMRIGACONT").Value
                If Not Pcls_PrimaNota.PGestRegPN.CPOutput.ClsAbbuoni.RecSetDatiPerAbbuoni.EOF Then
                    TXT_ABBUONO1OLD.Text = Pcls_PrimaNota.PGestRegPN.CPOutput.ClsAbbuoni.RecSetDatiPerAbbuoni.Fields("IMPORTO").Value
                End If
            End If
        End If
        TXT_ABBUONO1NEW.Text = TXT_ABBUONO1OLD.Text
        ...
        If Not Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.EOF Then
            ...
            Else
                TXT_CONTO2OLD.Text = MakeContoCliFor(Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_TIPOCF_CG44").Value, _
                                                     Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_CLIFORPAR_CG44").Value)
            End If
            ...
            TXT_CONTO2NEW.Text = TXT_CONTO2OLD.Text '   Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_CONTOPAR_CG24").Value
            ...
            If Not Pcls_PrimaNota.PGestRegPN.CPOutput.ClsAbbuoni Is Nothing Then
                If Not Pcls_PrimaNota.PGestRegPN.CPOutput.ClsAbbuoni.RecSetDatiPerAbbuoni Is Nothing Then
                    Pcls_PrimaNota.PGestRegPN.CPOutput.ClsAbbuoni.RecSetDatiPerAbbuoni.Filter = _
                               "RIGACONT = " & Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_NUMRIGACONT").Value
                    If Not Pcls_PrimaNota.PGestRegPN.CPOutput.ClsAbbuoni.RecSetDatiPerAbbuoni.EOF Then
                        TXT_ABBUONO2OLD.Text = Pcls_PrimaNota.PGestRegPN.CPOutput.ClsAbbuoni.RecSetDatiPerAbbuoni.Fields("IMPORTO").Value
                    End If
                End If
            End If
            TXT_ABBUONO2NEW.Text = TXT_ABBUONO2OLD.Text
        End If
        
        Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.MoveNext
        If Not Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.EOF Then
            If NVL(Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_TIPOCF_CG44").Value, -1) = -1 Then
                TXT_CONTO3OLD.Text = Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_CONTOPAR_CG24").Value
            Else
                TXT_CONTO3OLD.Text = MakeContoCliFor(Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_TIPOCF_CG44").Value, _
                                                     Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_CLIFORPAR_CG44").Value)
            End If
            TXT_DESCRAGG3OLD.Text = Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_DESCRAGG").Value
            TXT_IMPORTO3OLD.Text = Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_IMPTOTALE").Value
            CBO_SEGNO3OLD.Text = Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_INDDAAV").Value
            TXT_CONTO3NEW.Text = TXT_CONTO3OLD.Text '   Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_CONTOPAR_CG24").Value
            TXT_DESCRAGG3NEW.Text = Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_DESCRAGG").Value
            TXT_IMPORTO3NEW.Text = Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_IMPTOTALE").Value
            CBO_SEGNO3NEW.Text = Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_INDDAAV").Value
            ...
            If Not Pcls_PrimaNota.PGestRegPN.CPOutput.ClsAbbuoni Is Nothing Then
                If Not Pcls_PrimaNota.PGestRegPN.CPOutput.ClsAbbuoni.RecSetDatiPerAbbuoni Is Nothing Then
                    Pcls_PrimaNota.PGestRegPN.CPOutput.ClsAbbuoni.RecSetDatiPerAbbuoni.Filter = _
                               "RIGACONT = " & Pcls_PrimaNota.PGestRegPN.CPOutput.RecSetMovCont.Fields("CG42_NUMRIGACONT").Value
                    If Not Pcls_PrimaNota.PGestRegPN.CPOutput.ClsAbbuoni.RecSetDatiPerAbbuoni.EOF Then
                        TXT_ABBUONO3OLD.Text = Pcls_PrimaNota.PGestRegPN.CPOutput.ClsAbbuoni.RecSetDatiPerAbbuoni.Fields("IMPORTO").Value
                    End If
                End If
            End If
            TXT_ABBUONO3NEW.Text = TXT_ABBUONO3OLD.Text
        End If
    End If
...
Private Sub Form_Load()
    ...
    CBO_SEGNO3OLD.AddItemData "Dare", 1
    CBO_SEGNO3OLD.AddItemData "Avere", 2
    CBO_SEGNO3NEW.AddItemData "Dare", 1
    CBO_SEGNO3NEW.AddItemData "Avere", 2
...
''    Call Pcls_Decode.Conto(CallingForm.ActiveInterface.ClsGlobal.Gcls_DittaCorrente.ClsDatiGest.GruppoPdc, TXT_CONTO1OLD.Text)
    Call Pcls_Decode.ClienteFornitoreSoloRagioneSociale(TXT_CONTO1OLD.TipoCF, Right(NVL(TXT_CONTO1OLD.Text, "000000"), 6))
...
''    Call Pcls_Decode.Conto(CallingForm.ActiveInterface.ClsGlobal.Gcls_DittaCorrente.ClsDatiGest.GruppoPdc, TXT_CONTO1NEW.Text)
    Call Pcls_Decode.ClienteFornitoreSoloRagioneSociale(TXT_CONTO1NEW.TipoCF, Right(NVL(TXT_CONTO1NEW.Text, "000000"), 6))
...
''    Call Pcls_Decode.Conto(CallingForm.ActiveInterface.ClsGlobal.Gcls_DittaCorrente.ClsDatiGest.GruppoPdc, TXT_CONTO2OLD.Text)
    Call Pcls_Decode.ClienteFornitoreSoloRagioneSociale(TXT_CONTO2OLD.TipoCF, Right(NVL(TXT_CONTO2OLD.Text, "000000"), 6))
...
''    Call Pcls_Decode.Conto(CallingForm.ActiveInterface.ClsGlobal.Gcls_DittaCorrente.ClsDatiGest.GruppoPdc, TXT_CONTO2NEW.Text)
    Call Pcls_Decode.ClienteFornitoreSoloRagioneSociale(TXT_CONTO2NEW.TipoCF, Right(NVL(TXT_CONTO2NEW.Text, "000000"), 6))
...
Private Sub TXT_CONTO3NEW_StartDecode(Cancel As Boolean, str_SQL As String, Arr_Fields As Variant, Str_Connect As String)
    On Error Resume Next
    
    Cancel = False
    
    Set Pcls_Decode.CampoDecodifica = TXT_DESCRCONTO3NEW
''    Call Pcls_Decode.Conto(CallingForm.ActiveInterface.ClsGlobal.Gcls_DittaCorrente.ClsDatiGest.GruppoPdc, TXT_CONTO3NEW.Text)
    Call Pcls_Decode.ClienteFornitoreSoloRagioneSociale(TXT_CONTO3NEW.TipoCF, Right(NVL(TXT_CONTO3NEW.Text, "000000"), 6))
...
Private Sub TXT_CONTO3NEW_StartLookup(Cancel As Boolean, str_SQL As String, Arr_Fields As Variant, Str_Caption As String, Str_Connect As String)
    On Error GoTo Err_TXT_CONTO3NEW_StartLookup
    Str_Connect = StrConnect
Exit Sub
Err_TXT_CONTO3NEW_StartLookup:
    MsgBox Err.Number & " - " & Err.Description, , "TXT_CONTO3NEW_StartLookup"
    Exit Sub
End Sub
...
Private Sub SettaProprietaConti()
    ...
    Set TXT_CONTO3OLD.Connessione = Connessione
    TXT_CONTO3OLD.CodicePdC = CallingForm.ActiveInterface.ClsGlobal.Gcls_DittaCorrente.ClsDatiGest.GruppoPdc
    TXT_CONTO3OLD.Ditta = CallingForm.ActiveInterface.ClsGlobal.Gcls_DittaCorrente.CodDitta
    Set TXT_CONTO3NEW.Connessione = Connessione
    TXT_CONTO3NEW.CodicePdC = CallingForm.ActiveInterface.ClsGlobal.Gcls_DittaCorrente.ClsDatiGest.GruppoPdc
    TXT_CONTO3NEW.Ditta = CallingForm.ActiveInterface.ClsGlobal.Gcls_DittaCorrente.CodDitta
...
Private Sub CMD_UPDATE_Click()
    ...
    Dim RegistraModifiche               As Boolean
    
    On Error GoTo Err_CMD_UPDATE_Click
    
    RegistraModifiche = False
    ...
    If NVL(TXT_ABBUONO1OLD.Text, 0) <> NVL(TXT_ABBUONO1NEW.Text, 0) Then
        CampiDaModificareDettaglio = CampiDaModificareDettaglio + tsModificaImportoAbbuono
        Pcls_PrimaNota.PGestRegPN.CPInput.DatiDettaglio.ImportoAbbuono = NVL(TXT_ABBUONO1NEW.Text, 0)
    End If
    ...
    If NVL(TXT_ABBUONO2OLD.Text, 0) <> NVL(TXT_ABBUONO2NEW.Text, 0) Then
        CampiDaModificareDettaglio = CampiDaModificareDettaglio + tsModificaImportoAbbuono
        Pcls_PrimaNota.PGestRegPN.CPInput.DatiDettaglio.ImportoAbbuono = NVL(TXT_ABBUONO2NEW.Text, 0)
    End If
    ...
    '
    ' Determino i campi variati del dettaglio (riga 3)
    '
    CampiDaModificareDettaglio = tsModificaNiente
    
    If NVL(TXT_CONTO3OLD.Text, "") <> NVL(TXT_CONTO3NEW.Text, "") Then
        CampiDaModificareDettaglio = CampiDaModificareDettaglio + tsModificaConto
        Pcls_PrimaNota.PGestRegPN.CPInput.DatiDettaglio.Conto = NVL(TXT_CONTO3NEW.Text, "")
    End If
    
    If NVL(TXT_DESCRAGG3OLD.Text, "") <> NVL(TXT_DESCRAGG3NEW.Text, "") Then
        CampiDaModificareDettaglio = CampiDaModificareDettaglio + tsModificaDescrCausaleAgg
        Pcls_PrimaNota.PGestRegPN.CPInput.DatiDettaglio.DescrAggiuntiva = NVL(TXT_DESCRAGG3NEW.Text, "")
    End If
    
    If NVL(TXT_IMPORTO3OLD.Text, 0) <> NVL(TXT_IMPORTO3NEW.Text, 0) Or _
       NVL(CBO_SEGNO3OLD.Text, 0) <> NVL(CBO_SEGNO3NEW.Text, 0) Then
        CampiDaModificareDettaglio = CampiDaModificareDettaglio + tsModificaImporto + tsModificaSegno
        Pcls_PrimaNota.PGestRegPN.CPInput.DatiDettaglio.Importo = NVL(TXT_IMPORTO3NEW.Text, 0)
        Pcls_PrimaNota.PGestRegPN.CPInput.DatiDettaglio.Segno = NVL(CBO_SEGNO3NEW.Text, 0)
    End If
    
    If NVL(TXT_ABBUONO3OLD.Text, 0) <> NVL(TXT_ABBUONO3NEW.Text, 0) Then
        CampiDaModificareDettaglio = CampiDaModificareDettaglio + tsModificaImportoAbbuono
        Pcls_PrimaNota.PGestRegPN.CPInput.DatiDettaglio.ImportoAbbuono = NVL(TXT_ABBUONO3NEW.Text, 0)
    End If
    
    If CampiDaModificareDettaglio <> tsModificaNiente Then
        Pcls_PrimaNota.PGestRegPN.CPInput.DatiDettaglio.CodiceDitta = CallingForm.ActiveInterface.ClsGlobal.Gcls_DittaCorrente.CodDitta
        Pcls_PrimaNota.PGestRegPN.CPInput.DatiDettaglio.NumeroRegistrazione = TXT_NUMREG.Text
        Pcls_PrimaNota.PGestRegPN.CPInput.DatiDettaglio.NumeroRigaCont = 3
        Pcls_PrimaNota.PGestRegPN.ModificaRiga CampiDaModificareDettaglio
        If Pcls_PrimaNota.PGestRegPN.Stato <> tsOk Then
            MsgBox Pcls_PrimaNota.PGestRegPN.Errore & " in Pcls_PrimaNota.PGestRegPN.ModificaRiga"
            Exit Sub
    ...
    '
    If RegistraModifiche = True Then
...
Private Sub TXT_CONTO3OLD_StartDecode(Cancel As Boolean, str_SQL As String, Arr_Fields As Variant, Str_Connect As String)
    On Error Resume Next
    
    Cancel = False
    
    Set Pcls_Decode.CampoDecodifica = TXT_DESCRCONTO3OLD
''    Call Pcls_Decode.Conto(CallingForm.ActiveInterface.ClsGlobal.Gcls_DittaCorrente.ClsDatiGest.GruppoPdc, TXT_CONTO3OLD.Text)
    Call Pcls_Decode.ClienteFornitoreSoloRagioneSociale(TXT_CONTO3OLD.TipoCF, Right(NVL(TXT_CONTO3OLD.Text, "000000"), 6))
...
Private Sub TXT_CONTO3OLD_StartLookup(Cancel As Boolean, str_SQL As String, Arr_Fields As Variant, Str_Caption As String, Str_Connect As String)
    On Error GoTo Err_TXT_CONTO3OLD_StartLookup
    Str_Connect = StrConnect
Exit Sub
Err_TXT_CONTO3OLD_StartLookup:
    MsgBox Err.Number & " - " & Err.Description, , "TXT_CONTO3OLD_StartLookup"
    Exit Sub
End Sub

Private Function MakeContoCliFor(TipoCF As Variant, CliFor As Variant) As Variant
    Dim Mastro      As Variant
    
    On Error GoTo Err_MakeContoCliFor
    
    If TipoCF = 0 Then
        '
        ' Cliente
        '
        Mastro = CallingForm.ActiveInterface.ClsGlobal.Gcls_DittaCorrente.ClsPersPdc.MastroClienti
    Else
        '
        ' Fornitore
        '
        Mastro = CallingForm.ActiveInterface.ClsGlobal.Gcls_DittaCorrente.ClsPersPdc.MastroFornitori
    End If
    
    MakeContoCliFor = Left(Mastro, 2) & Right("00000000" & CliFor, 8)
Exit Function
Err_MakeContoCliFor:
    MsgBox Err.Number & " - " & Err.Description, , "MakeContoCliFor"
    Exit Function
End Function
